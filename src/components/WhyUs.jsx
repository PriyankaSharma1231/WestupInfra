...
const certs = [
  ...
  },
  {
    ...
    desc: "Jigyanshu Acharya · Pushpendra · Uday— all appointed at incorporation for aligned leadership.",
  },
];
    ...
    <section className="why">
      <div className="why__left">
        ...
        <p className="why__intro">
          Large solar EPC demands deep field capability, regulatory expertise,
          and a team that has executed under pressure. Westup Infra brings all
          three.
        </p>
      ...
      <div className="why__right">
        <div className="why__barmer-badge">
          <p>
            <strong>Barmer, Rajasthan</strong> receives some of India's highest
            solar irradiation — averaging <strong>6.0–6.5 kWh/m²/day</strong>.
            It sits within the same high-yield belt as Adani's largest solar
            parks in Jaisalmer and Bikaner — making us the ideal on-ground EPC
            partner for this region.
          </p>
        </div>

        <span className="section-label" style={{ marginTop: "8px" }}>
